...
# copied from transformers.models.bigbird_pegasus.modeling_bigbird_pegasus.shift_tokens_right
...
# copied from transformers.models.bigbird_pegasus.modeling_bigbird_pegasus._make_causal_mask
...
# copied from transformers.models.bigbird_pegasus.modeling_bigbird_pegasus._expand_mask
...
# copied from transformers.models.bigbird_pegasus.modeling_bigbird_pegasus.BigBirdPegasusLearnedPositionalEmbedding with BigBirdPegasusLearnedPositionalEmbedding->LayoutBigBirdPegasusLearnedPositionalEmbedding
class LayoutBigBirdPegasusLearnedPositionalEmbedding(nn.Embedding):
    """
...
class LayoutEmbeddings(nn.Module):
    ...
    def __init__(self, max_2d_position_embeddings, embed_dim):
        super(LayoutEmbeddings, self).__init__()
        self.x_position_embeddings = nn.Embedding(max_2d_position_embeddings, embed_dim)
        self.y_position_embeddings = nn.Embedding(max_2d_position_embeddings, embed_dim)
        self.h_position_embeddings = nn.Embedding(max_2d_position_embeddings, embed_dim)
        self.w_position_embeddings = nn.Embedding(max_2d_position_embeddings, embed_dim)
...
# Copied from transformers.models.big_bird.modeling_big_bird.BigBirdSelfAttention with BigBirdPegasus->LayoutBigBirdPegasus
class LayoutBigBirdPegasusSelfAttention(nn.Module):
...
# Copied from transformers.models.big_bird.modeling_big_bird.BigBirdBlockSparseAttention with BigBirdPegasus->LayoutBigBirdPegasus
class LayoutBigBirdPegasusBlockSparseAttention(nn.Module):
...
# Copied from transformers.models.bigbird_pegasus.modeling_bigbird_pegasus.BigBirdPegasusEncoderAttention with BigBirdPegasus->LayoutBigBirdPegasus
class LayoutBigBirdPegasusEncoderAttention(nn.Module):
    def __init__(self, config, seed=None):
        super().__init__()
        self.config = config
        self.seed = seed
        ...
        if self.attention_type == "original_full":
            self.self = LayoutBigBirdPegasusSelfAttention(config)
        elif self.attention_type == "block_sparse":
            self.self = LayoutBigBirdPegasusBlockSparseAttention(config, seed)
        else:
            raise ValueError(
    ...
    def set_attention_type(self, value: str):
        ...
        if value == "original_full":
            ...
            attn_weights = LayoutBigBirdPegasusSelfAttention(self.config)
        else:
            # copy all weights to new sparse attention class
            attn_weights = LayoutBigBirdPegasusBlockSparseAttention(self.config, self.seed)
...
# Copied from transformers.models.bigbird_pegasus.modeling_bigbird_pegasus.LayoutBigBirdPegasusDecoderAttention with BigBirdPegasusDecoder->LayoutBigBirdPegasusDecoder
class LayoutBigBirdPegasusDecoderAttention(nn.Module):
...
# Copied from transformers.models.bigbird_pegasus.modeling_bigbird_pegasus.BigBirdPegasusEncoderLayer with BigBirdPegasus->LayoutBigBirdPegasus
class LayoutBigBirdPegasusEncoderLayer(nn.Module):
    def __init__(self, config: LayoutBigBirdPegasusConfig, seed=None):
        super().__init__()
        self.attention_type = config.attention_type
        self.embed_dim = config.d_model
        self.self_attn = LayoutBigBirdPegasusEncoderAttention(config, seed=seed)
...
# Copied from transformers.models.bigbird_pegasus.modeling_bigbird_pegasus.BigBirdPegasusDecoderLayer with BigBirdPegasus->LayoutBigBirdPegasus
class LayoutBigBirdPegasusDecoderLayer(nn.Module):
    def __init__(self, config: LayoutBigBirdPegasusConfig):
        super().__init__()
        self.embed_dim = config.d_model
        self.self_attn = LayoutBigBirdPegasusDecoderAttention(
        ...
        self.self_attn_layer_norm = nn.LayerNorm(self.embed_dim)
        self.encoder_attn = LayoutBigBirdPegasusDecoderAttention(
            self.embed_dim,
...
# Copied from transformers.models.bigbird_pegasus.modeling_bigbird_pegasus.BigBirdPegasusPreTrainedModel with BigBirdPegasus->LayoutBigBirdPegasus
class LayoutBigBirdPegasusPreTrainedModel(PreTrainedModel):
    config_class = LayoutBigBirdPegasusConfig
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, (LayoutBigBirdPegasusDecoder, LayoutBigBirdPegasusEncoder)):
...
# Copied from transformers.models.bigbird_pegasus.modeling_bigbird_pegasus.BigBirdPegasusEncoder with BigBirdPegasus->LayoutBigBirdPegasus
class LayoutBigBirdPegasusEncoder(LayoutBigBirdPegasusPreTrainedModel):
    """
    ...
    def __init__(self, config: LayoutBigBirdPegasusConfig, embed_tokens: Optional[nn.Embedding] = None):
        ...
        self.embed_layout = LayoutEmbeddings(config.max_2d_position_embeddings, embed_dim)

        self.embed_positions = LayoutBigBirdPegasusLearnedPositionalEmbedding(
            config.max_position_embeddings,
            embed_dim,
        )
        self.layers = nn.ModuleList([LayoutBigBirdPegasusEncoderLayer(config, seed=i) for i in range(config.encoder_layers)])
...
# Copied from transformers.models.bigbird_pegasus.modeling_bigbird_pegasus.BigBirdPegasusEncoder with BigBirdPegasus->LayoutBigBirdPegasus
class LayoutBigBirdPegasusDecoder(LayoutBigBirdPegasusPreTrainedModel):
    """
    Transformer decoder consisting of *config.decoder_layers* layers. Each layer is a
    [`LayoutBigBirdPegasusDecoderLayer`]
    Args:
        config: LayoutBigBirdPegasusConfig
        embed_tokens (nn.Embedding): output embedding
    """
    ...
    def __init__(self, config: LayoutBigBirdPegasusConfig, embed_tokens: Optional[nn.Embedding] = None):
        ...
        self.layers = nn.ModuleList([LayoutBigBirdPegasusDecoderLayer(config) for _ in range(config.decoder_layers)])
...
# Copied from transformers.models.bigbird_pegasus.modeling_bigbird_pegasus.LayoutBigBirdPegasusForConditionalGeneration with BigBirdPegasus->LayoutBigBirdPegasus
class LayoutBigBirdPegasusForConditionalGeneration(LayoutBigBirdPegasusPreTrainedModel):
    base_model_prefix = "model"
